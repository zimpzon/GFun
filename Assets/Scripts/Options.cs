...
public class Options : MonoBehaviour
{
    ...
    void Awake()
    {
        MusicVolume = PlayerPrefs.GetFloat(PlayerPrefsNames.MaxMusicVolume, 0);
        SFxVolume = PlayerPrefs.GetFloat(PlayerPrefsNames.SfxVolume, 0);
        AmbientVolume = PlayerPrefs.GetFloat(PlayerPrefsNames.AmbientVolume, 0);
